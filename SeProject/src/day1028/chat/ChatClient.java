...
public class ChatClient extends JFrame implements KeyListener, ActionListener{
	...
	JTextField t_input;
	JButton bt;
	JButton bt_open;			//대화상대방을 띄우는 버튼		//12. bt_open추가
	ChatClient2 ch2;
	
	public ChatClient() {
		//19. 나보다 부모가 먼저 태어나야함. super() > JFrame("부모창") : 디폴트로 남기지 말고 정의하자
		super("난 부모창");
		//2.생성
		area = new JTextArea();
	...
	//17. 대화할 상대방 윈도우 띄우기!
	public void open() {
		//ChatClient2를 화면에 띄우기! > ChatClient2의 생성자 호출
		ch2 = new ChatClient2(this);	//누구나 다 볼수있게 멤버변수로 뺴주기
	}
